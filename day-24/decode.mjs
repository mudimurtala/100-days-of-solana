...
// accountInfo.data comes back as [base64String, "base64"]
// Convert that base64 string back into raw bytes
...
// -------------------------------------------------------
// 2. Decode using the pre-built Token Program codec
// -------------------------------------------------------
...
// -------------------------------------------------------
// 3. Decode manually byte by byte using DataView
// -------------------------------------------------------
...
// -------------------------------------------------------
// 5. Final comparison to confirm all three agree
// -------------------------------------------------------
...
console.log("RPC Parsed Mint Auth: ", mintInfo.mintAuthority ?? "None");

console.log("\nCodec Freeze Authority: ", codecFreezeAuthority);
console.log("Manual Freeze Authority:", manualFreezeAuthority);
console.log("RPC Parsed Freeze Auth: ", mintInfo.freezeAuthority ?? "None");